...
echo "  2. Tune client behavior in: $ROOT_DIR/clients/$CLIENT_ID/soul.md"
echo "  3. Local demo: ./scripts/start-local-stack.sh $CLIENT_ID"
echo "  4. VPS/container deploy: ./docker/deploy-client.sh $CLIENT_ID"
echo "  5. Open admin detail: http://127.0.0.1:18800/client/$CLIENT_ID"
echo ""
