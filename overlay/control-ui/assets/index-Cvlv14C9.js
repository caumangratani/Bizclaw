            ...
            <div class="usage-export-popover">
              <div class="usage-export-list">
                <button
                  ...
                  @click=${()=>Ps(`bizclaw-usage-sessions-${te}.csv`,Wg(u),"text/csv")}
                  ?disabled=${u.length===0}
                >
                  Sessions CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>Ps(`bizclaw-usage-daily-${te}.csv`,qg(z),"text/csv")}
                  ?disabled=${z.length===0}
                >
                  Daily CSV
                </button>
                <button
                  class="usage-export-item"
                  @click=${()=>Ps(`bizclaw-usage-${te}.json`,JSON.stringify({totals:I,sessions:u,daily:z,aggregates:F},null,2),"application/json")}
        ...
        <div class="stack" style="margin-top: 12px;">
          <div>
            ...
            ${n?r`<div class="callout ${o}" style="margin-top: 8px;">
                  ...
                  <span class="mono">bizclaw security check</span> for details.
                </div>`:v}
  ...
  `}function cb(e){const t=e.hello?.snapshot,n=t?.uptimeMs?Di(t.uptimeMs):"n/a",s=t?.policy?.tickIntervalMs?`${t.policy.tickIntervalMs}ms`:"n/a",a=t?.authMode==="trusted-proxy",o=(()=>{if(e.connected||!e.lastError)return null;const c=e.lastError.toLowerCase();if(!(c.includes("unauthorized")||c.includes("connect failed")))return null;const g=!!e.settings.token.trim(),p=!!e.password.trim();return!g&&!p?r`
        <div class="muted" style="margin-top: 8px">
          ...
          <div style="margin-top: 6px">
            <span class="mono">bizclaw dashboard</span> → open the Control UI<br />
            <span class="mono">bizclaw setup-token</span> → set token
          </div>
          <div style="margin-top: 6px">
            <a
              class="session-link"
              href="https://bizgenix.in/bizclaw/help"
              target="_blank"
              rel="noreferrer"
        ...
        <div class="topbar-left">
          ...
          <div class="brand">
            <div class="brand-logo">
              <img src=${p?`${p}/favicon.svg`:"/favicon.svg"} alt="BizClaw" />
            </div>
            <div class="brand-text">
              <div class="brand-title">BIZCLAW</div>
        ...
        <div class="nav-group nav-group--links">
          ...
          <div class="nav-group__items">
            <a
              ...
              href="https://bizgenix.in/bizclaw"
              target="_blank"
              rel="noreferrer"
